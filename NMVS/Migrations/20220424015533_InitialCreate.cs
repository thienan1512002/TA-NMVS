        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemUm = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ItemPkgQty = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ItemPkg = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ItemWhUnit = table.Column<float>(type: "real", nullable: false),
                    Active = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UploadBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UploadReportId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UploadErrors", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UploadErrors_UploadReports_UploadReportId",
                        column: x => x.UploadReportId,
                        principalTable: "UploadReports",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UploadErrors_UploadReportId",
                table: "UploadErrors",
                column: "UploadReportId");
        }
